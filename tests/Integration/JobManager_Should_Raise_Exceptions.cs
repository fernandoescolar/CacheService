...
public class JobManager_Should_Raise_Exceptions : IntegrationTestBase
{
    private readonly string key;
    private readonly CacheServiceOptions options;

    public JobManager_Should_Raise_Exceptions()
    {
    ...
    protected override void OnConfigure(CacheServiceConfiguration configuration)
    {
        ...
        configuration.BackgroundJobIgnoreExceptions = false;
    }
